...
| `/analysis` | `analysis/page.tsx` | Server | Portfolio / AI Analyst / AI Screening / Sector / ETF / VN30 / VN100 / Avg Down / Exit Strategy / Scoring rules / **Principles**; Portfolio/VN30/VN100 have Fundamental/Technical/Combined/**Swing** sub-tabs | `combined-analysis`, `sector-analysis`, `etf-analysis`, shared portfolio cache |
